                            ...
                            ->arrayNode('properties')
                                ...
                                ->arrayPrototype()
                                    ...
                                    ->children()
                                        ...
                                        ->booleanNode('readableLink')->defaultTrue()->info('Is the property eager-loaded via ApiPlatform?')->end()
                                        ->booleanNode('writable')->defaultTrue()->info('Is the property writable?')->end()
                                        ->booleanNode('writableLink')->defaultTrue()->info('Is the property writable via ApiPlatform?')->end()
